...
```html
<p>
  Ceres ist nach der römischen Göttin des Ackerbaus benannt; ihr astronomisches Symbol ist daher
  eine stilisierte Sichel: ⚳.
  <sup>
    <a
  ...
  <ol>
    <li id="user-content-fn-nasa-2015">
      <p>
        ...
        In: Jet Propulsion Laboratory. 22. April 2015, abgerufen am 19. Januar 2022 (englisch).
        <a
